package Challenges.Challenge26.TimsSolution;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        albums.get(0).addtoPlayList("Smash", playlist);
        albums.get(0).addtoPlayList("Genocide", playlist);
        albums.get(0).addtoPlayList("BasketCase", playlist);
