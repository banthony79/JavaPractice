...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Store store = new Store("Bryce's Store");
        ...
        /*//store.returnProduct("260504");
        System.out.println(store.returnProduct("260489").getName());
        store.returnProduct("260491");
        System.out.println(store.productSearch("260499").getName());
        System.out.println(store.returnProduct("260491").isAvailable());
        store.purchase("260503");
        store.purchase("260499");*/
